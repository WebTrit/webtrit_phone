...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get copyToClipboard_floatingSnackBar => 'Texte copié';

  @override
  String get copyToClipboard_popupMenuItem => 'Copier dans le presse-papiers';

  @override
  String get default_ClientExceptionError => 'Un problème de client HTTP s\'est produit';

  @override
  String get default_FormatExceptionError => 'Un problème de réponse s\'est produit';

  @override
  String get default_RequestFailureError => 'Une défaillance du serveur s\'est produite';

  @override
  String get default_SocketExceptionError => 'Un problème réseau s\'est produit';

  @override
  String get default_TlsExceptionError => 'Un problème de réseau sécurisé s\'est produit';

  @override
  String get default_TypeErrorError => 'Un problème de réponse s\'est produit';

  @override
  String get default_UnauthorizedRequestFailureError => 'Une défaillance de la demande non autorisée s\'est produite';
  ...
  @override
  String get locale_default => 'Par défaut';
  ...
  @override
  String get login_RequestFailureOtpAlreadyVerifiedError => 'Vérification déjà vérifiée';

  @override
  String get login_RequestFailureOtpExpiredError => 'Vérification expirée';

  @override
  String get login_RequestFailureOtpIdVerifyAttemptsExceededError => '';

  @override
  String get login_RequestFailureOtpNotFoundError => 'Vérification introuvable';

  @override
  String get login_RequestFailurePhoneNotFoundError => '';

  @override
  String get login_RequestFailureUnconfiguredBundleIdError => 'Erreur de configuration du backend de l\'application - veuillez informer votre fournisseur de services';
  ...
  String login_Text_coreUrlAssignPostDescription(Object email) {
    return 'Si vous n\'avez pas encore votre propre backend cloud WebTrit, contactez l\'équipe de vente à l\'adresse $email';
  }
  ...
  @override
  String get main_CompatibilityIssueDialogActions_update => 'Mise à jour';
  ...
  String recents_BodyCenter_empty(Object filter) {
    return 'Actuellement, vous n\'avez aucun appel récent avec $filter.';
  }
  ...
  @override
  String get settings_AccountDeleteConfirmDialog_content => 'Êtes-vous sûr de vouloir supprimer le compte?';

  @override
  String get settings_AccountDeleteConfirmDialog_title => 'Confirmer la suppression du compte';

  @override
  String get settings_AppBarTitle_myAccount => '';

  @override
  String get settings_ForceLogoutConfirmDialog_content => 'Êtes-vous sûr de vouloir forcer la déconnexion?';

  @override
  String get settings_ForceLogoutConfirmDialog_title => 'Confirmer la déconnexion forcée';
  ...
  @override
  String get settings_ListViewTileTitle_accountDelete => 'Supprimer le compte';
