...
class EnvironmentConfig {
  ...
  static const USER_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME = 'WEBTRIT_APP_USER_REPOSITORY_POLLING_SECONDS_INTERVAL';
  static const USER_REPOSITORY_POLLING_SECONDS_INTERVAL = int.fromEnvironment(
    USER_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME,
    defaultValue: 10,
  );

  static const SYSTEM_INFO_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME =
      'WEBTRIT_APP_SYSTEM_INFO_REPOSITORY_POLLING_SECONDS_INTERVAL';
  static const SYSTEM_INFO_REPOSITORY_POLLING_SECONDS_INTERVAL = int.fromEnvironment(
    SYSTEM_INFO_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME,
    defaultValue: 300,
  );

  static const EXTERNAL_CONTACTS_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME =
      'WEBTRIT_APP_EXTERNAL_CONTACTS_REPOSITORY_POLLING_SECONDS_INTERVAL';
  static const EXTERNAL_CONTACTS_REPOSITORY_POLLING_SECONDS_INTERVAL = int.fromEnvironment(
    EXTERNAL_CONTACTS_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME,
    defaultValue: 60,
  );

  static const VOICEMAIL_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME =
      'WEBTRIT_APP_VOICEMAIL_REPOSITORY_POLLING_SECONDS_INTERVAL';
  static const VOICEMAIL_REPOSITORY_POLLING_SECONDS_INTERVAL = int.fromEnvironment(
    VOICEMAIL_REPOSITORY_POLLING_SECONDS_INTERVAL__NAME,
    defaultValue: 300,
  );
}
