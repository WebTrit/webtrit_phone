...
class _$ButtonWidgetConfigCopyWithImpl<$Res, $Val extends ButtonWidgetConfig>
  ...
  @override
  $Res call({
    Object? primaryElevatedButton = freezed,
  }) {
    return _then(_value.copyWith(
      primaryElevatedButton: freezed == primaryElevatedButton
  ...
  @pragma('vm:prefer-inline')
  $ElevatedButtonWidgetConfigCopyWith<$Res>? get primaryElevatedButton {
    if (_value.primaryElevatedButton == null) {
      return null;
    }
...
class _$GroupWidgetConfigCopyWithImpl<$Res, $Val extends GroupWidgetConfig>
  ...
  @pragma('vm:prefer-inline')
  $GroupTitleListTileWidgetConfigCopyWith<$Res>? get groupTitleListTile {
    if (_value.groupTitleListTile == null) {
      return null;
    }
...
abstract class _ExtTabBarWidgetConfig implements ExtTabBarWidgetConfig {
  const factory _ExtTabBarWidgetConfig(
      ...
      final Color? backgroundColor,
      final Color? selectedItemColor,
      final Color? unSelectedItemColor}) = _$ExtTabBarWidgetConfigImpl;
...
abstract class $TextFormFieldWidgetConfigCopyWith<$Res> {
  ...
  @useResult
  $Res call({Color? labelColor, InputBorderWidgetConfig? border});
...
abstract class $BorderWidgetConfigCopyWith<$Res> {
  ...
  @useResult
  $Res call({Color? typicalColor, Color? errorColor});
}
...
abstract class _BorderWidgetConfig implements BorderWidgetConfig {
  const factory _BorderWidgetConfig(
      {final Color? typicalColor,
      final Color? errorColor}) = _$BorderWidgetConfigImpl;
...
abstract class _TextSelectionWidgetConfig implements TextSelectionWidgetConfig {
  const factory _TextSelectionWidgetConfig(
      {final Color? cursorColor,
      final Color? selectionColor,
      final Color? selectionHandleColor}) = _$TextSelectionWidgetConfigImpl;
