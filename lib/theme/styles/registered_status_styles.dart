...
class RegisteredStatusStyles extends ThemeExtension<RegisteredStatusStyles> {
  const RegisteredStatusStyles({required this.primary});

  final RegisteredStatusStyle primary;

  @override
  ThemeExtension<RegisteredStatusStyles> copyWith({RegisteredStatusStyle? primary}) {
    return RegisteredStatusStyles(primary: primary ?? this.primary);
  }
