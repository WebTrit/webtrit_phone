...
class LeadingAvatarStyles extends ThemeExtension<LeadingAvatarStyles> {
  ...
  @override
  ThemeExtension<LeadingAvatarStyles> copyWith({
    LeadingAvatarStyle? primary,
  }) {
  ...
  @override
  ThemeExtension<LeadingAvatarStyles> lerp(
    ThemeExtension<LeadingAvatarStyles>? other,
    double t,
  ) {
    if (other is! LeadingAvatarStyles) return this;
    return LeadingAvatarStyles(
      primary: LeadingAvatarStyle.lerp(primary, other.primary, t),
    );
  }
}
