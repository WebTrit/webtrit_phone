...
@override
int get hashCode => Object.hashAll([runtimeType,direction,line,callId,handle,createdTime,video,videoPermissionDenied,processingStatus,frontCamera,held,muted,updating,incomingOffer,displayName,fromReferId,fromReplaces,fromNumber,acceptedTime,hungUpTime,transfer,const DeepCollectionEquality().hash(failure),localStream,remoteStream,remoteCameraEnabled,speakerOnBeforeMinimize,const DeepCollectionEquality().hash(iceCandidates),iceConnectionIssue,networkQuality]);
