...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContactsExternalTabStarted&&(identical(other.search, search) || other.search == search));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ContactsExternalTabStarted value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ContactsExternalTabStarted value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ContactsExternalTabStarted value)?  $default,){
final _that = this;
switch (_that) {
case _ContactsExternalTabStarted() when $default != null:
return $default(_that);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContactsExternalTabStarted&&(identical(other.search, search) || other.search == search));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContactsExternalTabRefreshed);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ContactsExternalTabRefreshed value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ContactsExternalTabRefreshed value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ContactsExternalTabRefreshed value)?  $default,){
final _that = this;
switch (_that) {
case _ContactsExternalTabRefreshed() when $default != null:
return $default(_that);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContactsExternalTabRefreshed);
}
