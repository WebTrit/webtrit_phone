...
class _ContactScreenState extends State<ContactScreen> {
  ...
  void _onAudioPressed(ContactPhone phone, Contact contact) {
    _callController.createCall(destination: phone.sanitizedNumber, displayName: contact.maybeName, video: false);
  }

  void _onVideoPressed(ContactPhone phone, Contact contact) {
    _callController.createCall(destination: phone.sanitizedNumber, displayName: contact.maybeName, video: true);
  }

  void _onTransferPressed(ContactPhone phone) {
    _callController.submitTransfer(phone.sanitizedNumber);
    context.router.maybePop();
  }

  void _onCallFromPressed(ContactPhone phone, Contact contact, String fromNumber) {
    _callController.createCall(destination: phone.sanitizedNumber, displayName: contact.maybeName, fromNumber: fromNumber);
  }
