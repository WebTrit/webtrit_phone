...
class _LoginRequestTabState extends State<OtpRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<OtpCubit, OtpState>(
      listenWhen: (previous, current) =>
          ...
          context.router.isRouteActive(OtpRequestScreenPageRoute.name),
      listener: (context, state) => context.router.push(const OtpVerifyScreenPageRoute()),
                    ...
                    children: [
                      ...
                      if (state.demo)
                        TextFormField(
                          ...
                          onChanged: (value) => context.read<OtpCubit>().loginOptRequestEmailInputChanged(value),
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) => context.read<OtpCubit>().loginOptRequestPhoneInputChanged(value),
  ...
  void _onOtpRequestSubmitted(BuildContext context) {
    ...
    context.read<OtpCubit>().loginOptRequestSubmitted();
  }
}
