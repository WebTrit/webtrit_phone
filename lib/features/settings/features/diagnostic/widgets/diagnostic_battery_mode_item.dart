...
class DiagnosticBatteryModeItem extends StatelessWidget {
  const DiagnosticBatteryModeItem({super.key, required this.onTap, required this.batteryMode});
  ...
  Widget build(BuildContext context) {
    ...
    final statusIcon = batteryMode == CallkeepAndroidBatteryMode.unrestricted
        ? Icons.check_circle
        : Icons.error_outline;
