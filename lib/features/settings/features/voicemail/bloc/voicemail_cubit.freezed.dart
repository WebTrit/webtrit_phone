...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('status', status))..add(DiagnosticsProperty('items', items))..add(DiagnosticsProperty('error', error));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _VoicemailState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _VoicemailState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _VoicemailState value)?  $default,){
final _that = this;
switch (_that) {
case _VoicemailState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VoicemailStatus status,  List<Voicemail> items,  DefaultErrorNotification? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VoicemailState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( VoicemailStatus status,  List<Voicemail> items,  DefaultErrorNotification? error)  $default,) {final _that = this;
switch (_that) {
case _VoicemailState():
return $default(_that.status,_that.items,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( VoicemailStatus status,  List<Voicemail> items,  DefaultErrorNotification? error)?  $default,) {final _that = this;
switch (_that) {
case _VoicemailState() when $default != null:
return $default(_that.status,_that.items,_that.error);case _:
  return null;
...
class _VoicemailState extends VoicemailState with DiagnosticableTreeMixin {
  const _VoicemailState({this.status = VoicemailStatus.loading, final  List<Voicemail> items = const [], this.error}): _items = items,super._();
  

@override@JsonKey() final  VoicemailStatus status;
 final  List<Voicemail> _items;
@override@JsonKey() List<Voicemail> get items {
  if (_items is EqualUnmodifiableListView) return _items;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_items);
}

@override final  DefaultErrorNotification? error;

/// Create a copy of VoicemailState
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$VoicemailStateCopyWith<_VoicemailState> get copyWith => __$VoicemailStateCopyWithImpl<_VoicemailState>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VoicemailState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.error, error) || other.error == error));
}
...
/// @nodoc
abstract mixin class _$VoicemailStateCopyWith<$Res> implements $VoicemailStateCopyWith<$Res> {
  factory _$VoicemailStateCopyWith(_VoicemailState value, $Res Function(_VoicemailState) _then) = __$VoicemailStateCopyWithImpl;
@override @useResult
$Res call({
 VoicemailStatus status, List<Voicemail> items, DefaultErrorNotification? error
});
...
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as VoicemailStatus,items: null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<Voicemail>,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as DefaultErrorNotification?,
  ));
}
