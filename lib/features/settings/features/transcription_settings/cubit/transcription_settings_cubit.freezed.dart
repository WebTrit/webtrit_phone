...
mixin _$TranscriptionSettingsState {
 ...
 LocalTranscriptionModel get defaultModel; LocalTranscriptionModel get selectedModel; Set<String> get downloadedModels; ModelDownloadState get downloadState;
...
@useResult
$Res call({
 LocalTranscriptionModel defaultModel, LocalTranscriptionModel selectedModel, Set<String> downloadedModels, ModelDownloadState downloadState
});
...
as LocalTranscriptionModel,selectedModel: null == selectedModel ? _self.selectedModel : selectedModel // ignore: cast_nullable_to_non_nullable
as LocalTranscriptionModel,downloadedModels: null == downloadedModels ? _self.downloadedModels : downloadedModels // ignore: cast_nullable_to_non_nullable
