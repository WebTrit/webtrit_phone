...
@useResult
$Res call({
 bool processing, LoginMode? mode, String? coreUrl, String? tenantId, WebtritSystemInfo? systemInfo, List<LoginType>? supportedLoginTypes, (SessionOtpProvisional, DateTime)? otpSigninSessionOtpProvisionalWithDateTime, bool passwordSigninPasswordInputObscureText, (SessionOtpProvisional, DateTime)? signupSessionOtpProvisionalWithDateTime, String? token, String? userId, EmbeddedData? embedded, Map<String, dynamic>? embeddedExtras, Map<String, dynamic>? embeddedCallbackData, Object? embeddedRequestError, UrlInput coreUrlInput, Object? coreUrlAssignError, UserRefInput otpSigninUserRefInput, CodeInput otpSigninCodeInput, UserRefInput passwordSigninUserRefInput, PasswordInput passwordSigninPasswordInput, EmailInput signupEmailInput, CodeInput signupCodeInput
});
...
as UrlInput,coreUrlAssignError: freezed == coreUrlAssignError ? _self.coreUrlAssignError : coreUrlAssignError ,otpSigninUserRefInput: null == otpSigninUserRefInput ? _self.otpSigninUserRefInput : otpSigninUserRefInput // ignore: cast_nullable_to_non_nullable
