...
class EmbeddedRequestErrorStyle with Diagnosticable {
  const EmbeddedRequestErrorStyle({this.picture});
  ...
  static EmbeddedRequestErrorStyle? lerp(EmbeddedRequestErrorStyle? a, EmbeddedRequestErrorStyle? b, double t) {
    if (identical(a, b)) return a;
    return EmbeddedRequestErrorStyle(picture: t < 0.5 ? a?.picture : b?.picture);
  }
