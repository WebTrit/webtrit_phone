...
export 'login_otp_signin_verify_screen_style.dart';
export 'login_otp_signin_verify_screen_styles.dart';
...
class LoginOtpSigninVerifyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final LoginOtpSigninVerifyScreenStyles? style = themeData.extension<LoginOtpSigninVerifyScreenStyles>();
