  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<LoginCubit, LoginState>(
      builder: (context, state) {
        ...
        String otpSigninRequestPostDescriptionText = context.l10n.login_Text_otpSigninRequestPostDescription;

        const postTextEnvOverride = EnvironmentConfig.OTP_SIGNIN_POST_DESCRIPTION_TEXT;
        if (postTextEnvOverride.isNotEmpty) {
          otpSigninRequestPostDescriptionText = postTextEnvOverride;
        }
