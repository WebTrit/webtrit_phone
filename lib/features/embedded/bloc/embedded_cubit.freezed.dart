...
mixin _$EmbeddedState {
 ...
 Map<String, dynamic> get payload; String get currentUrl; bool get canGoBack; bool get payloadReady; EmbeddedIntents? get intent;
...
@useResult
$Res call({
 Map<String, dynamic> payload, String currentUrl, bool canGoBack, bool payloadReady, EmbeddedIntents? intent
});
...
/// Create a copy of EmbeddedState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? payload = null,Object? currentUrl = null,Object? canGoBack = null,Object? payloadReady = null,Object? intent = freezed,}) {
...
as bool,payloadReady: null == payloadReady ? _self.payloadReady : payloadReady // ignore: cast_nullable_to_non_nullable
