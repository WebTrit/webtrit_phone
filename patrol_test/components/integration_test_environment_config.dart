...
class IntegrationTestEnvironmentConfig {
  ...
  static const EXT_CONTACT_UNIQUE_A_NAME__NAME = 'WEBTRIT_APP_TEST_EXT_CONTACT_UNIQUE_A_NAME';
  static const EXT_CONTACT_UNIQUE_A_NAME = String.fromEnvironment(EXT_CONTACT_UNIQUE_A_NAME__NAME);

  static const EXT_CONTACT_UNIQUE_A_NUMBER__NAME = 'WEBTRIT_APP_TEST_EXT_CONTACT_UNIQUE_A_NUMBER';
  static const EXT_CONTACT_UNIQUE_A_NUMBER = String.fromEnvironment(EXT_CONTACT_UNIQUE_A_NUMBER__NAME);

  static const EXT_CONTACT_UNIQUE_B_NAME__NAME = 'WEBTRIT_APP_TEST_EXT_CONTACT_UNIQUE_B_NAME';
  static const EXT_CONTACT_UNIQUE_B_NAME = String.fromEnvironment(EXT_CONTACT_UNIQUE_B_NAME__NAME);

  static const EXT_CONTACT_UNIQUE_B_NUMBER__NAME = 'WEBTRIT_APP_TEST_EXT_CONTACT_UNIQUE_B_NUMBER';
  static const EXT_CONTACT_UNIQUE_B_NUMBER = String.fromEnvironment(EXT_CONTACT_UNIQUE_B_NUMBER__NAME);
