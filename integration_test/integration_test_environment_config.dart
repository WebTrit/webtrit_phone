...
class IntegrationTestEnvironmentConfig {
  ...
  static const LOGIN_TEST_CORE_URL__NAME = 'WEBTRIT_APP_LOGIN_TEST_CORE_URL';
  static const LOGIN_TEST_CORE_URL = bool.hasEnvironment(LOGIN_TEST_CORE_URL__NAME)
      ? String.fromEnvironment(
          LOGIN_TEST_CORE_URL__NAME,
        )
      : null;
