...
import 'just_run_test.dart' as just_run_test;
import 'login_system_test.dart' as login_system_test;
...
Future<void> main() async {
  ...
  group('just_run_test', just_run_test.main);
  group('login_system_test', login_system_test.main);
