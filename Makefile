...
# Rules
.PHONY: run build configure configure-clean configure-demo configure-classic build-ios build-apk build-appbundle clean-git generate-package-config rename-package
