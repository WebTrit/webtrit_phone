...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PSignalingServiceStatus {
      ...
      val incomingCallHandlerHandle = pigeonVar_list[4] as Long
      val moduleFactoryHandle = pigeonVar_list[5] as Long
      return PSignalingServiceStatus(enabled, coreUrl, tenantId, token, incomingCallHandlerHandle, moduleFactoryHandle)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.enabled, other.enabled) && MessagesPigeonUtils.deepEquals(this.coreUrl, other.coreUrl) && MessagesPigeonUtils.deepEquals(this.tenantId, other.tenantId) && MessagesPigeonUtils.deepEquals(this.token, other.token) && MessagesPigeonUtils.deepEquals(this.incomingCallHandlerHandle, other.incomingCallHandlerHandle) && MessagesPigeonUtils.deepEquals(this.moduleFactoryHandle, other.moduleFactoryHandle)
  }
