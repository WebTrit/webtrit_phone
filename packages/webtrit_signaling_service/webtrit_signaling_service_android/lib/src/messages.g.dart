...
class PSignalingServiceStatus {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(enabled, other.enabled) && _deepEquals(coreUrl, other.coreUrl) && _deepEquals(tenantId, other.tenantId) && _deepEquals(token, other.token) && _deepEquals(incomingCallHandlerHandle, other.incomingCallHandlerHandle);
  }
