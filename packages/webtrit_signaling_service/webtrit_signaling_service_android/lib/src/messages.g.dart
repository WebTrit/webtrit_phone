...
class PSignalingServiceStatus {
  ...
  static PSignalingServiceStatus decode(Object result) {
    ...
    return PSignalingServiceStatus(
      ...
      incomingCallHandlerHandle: result[4]! as int,
      moduleFactoryHandle: result[5]! as int,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(enabled, other.enabled) && _deepEquals(coreUrl, other.coreUrl) && _deepEquals(tenantId, other.tenantId) && _deepEquals(token, other.token) && _deepEquals(incomingCallHandlerHandle, other.incomingCallHandlerHandle) && _deepEquals(moduleFactoryHandle, other.moduleFactoryHandle);
  }
