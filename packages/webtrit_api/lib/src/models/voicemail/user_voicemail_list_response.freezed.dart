...
mixin _$UserVoicemailListResponse {
  ...
  $UserVoicemailListResponseCopyWith<UserVoicemailListResponse> get copyWith =>
      _$UserVoicemailListResponseCopyWithImpl<UserVoicemailListResponse>(
          this as UserVoicemailListResponse, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UserVoicemailListResponse &&
  ...
  int get hashCode => Object.hash(
      runtimeType, hasNewMessages, const DeepCollectionEquality().hash(items));
...
abstract mixin class $UserVoicemailListResponseCopyWith<$Res> {
  factory $UserVoicemailListResponseCopyWith(UserVoicemailListResponse value,
          $Res Function(UserVoicemailListResponse) _then) =
...
mixin _$UserVoicemailItem {
  ...
  $UserVoicemailItemCopyWith<UserVoicemailItem> get copyWith =>
      _$UserVoicemailItemCopyWithImpl<UserVoicemailItem>(
          this as UserVoicemailItem, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UserVoicemailItem &&
...
abstract mixin class $UserVoicemailItemCopyWith<$Res> {
  factory $UserVoicemailItemCopyWith(
          UserVoicemailItem value, $Res Function(UserVoicemailItem) _then) =
      _$UserVoicemailItemCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String date,
