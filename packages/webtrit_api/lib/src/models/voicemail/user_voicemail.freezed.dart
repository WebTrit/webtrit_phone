...
abstract class $UserVoicemailCopyWith<$Res> {
  factory $UserVoicemailCopyWith(
          UserVoicemail value, $Res Function(UserVoicemail) then) =
...
abstract class _$$UserVoicemailImplCopyWith<$Res>
  ...
  factory _$$UserVoicemailImplCopyWith(
          _$UserVoicemailImpl value, $Res Function(_$UserVoicemailImpl) then) =
...
class __$$UserVoicemailImplCopyWithImpl<$Res>
  ...
  __$$UserVoicemailImplCopyWithImpl(
      _$UserVoicemailImpl _value, $Res Function(_$UserVoicemailImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UserVoicemailImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$UserVoicemailImpl implements _UserVoicemail {
  ...
  Map<String, dynamic> toJson() {
    return _$$UserVoicemailImplToJson(
      this,
    );
  }
}
...
abstract class $UserVoicemailAttachmentCopyWith<$Res> {
  factory $UserVoicemailAttachmentCopyWith(UserVoicemailAttachment value,
...
class __$$UserVoicemailAttachmentImplCopyWithImpl<$Res>
    extends _$UserVoicemailAttachmentCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$UserVoicemailAttachmentImpl(
      filename: null == filename
          ? _value.filename
          : filename // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$UserVoicemailAttachmentImpl implements _UserVoicemailAttachment {
  ...
  _$$UserVoicemailAttachmentImplCopyWith<_$UserVoicemailAttachmentImpl>
      get copyWith => __$$UserVoicemailAttachmentImplCopyWithImpl<
          _$UserVoicemailAttachmentImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserVoicemailAttachmentImplToJson(
      this,
    );
  }
}
...
abstract class _UserVoicemailAttachment implements UserVoicemailAttachment {
  const factory _UserVoicemailAttachment(
      ...
      required final int size,
      required final String type,
      required final String subtype}) = _$UserVoicemailAttachmentImpl;
