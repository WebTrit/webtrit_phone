...
UserVoicemailListResponse _$UserVoicemailListResponseFromJson(Map<String, dynamic> json) => UserVoicemailListResponse(
  ...
  items: (json['items'] as List<dynamic>).map((e) => UserVoicemailItem.fromJson(e as Map<String, dynamic>)).toList(),
);
...
UserVoicemailItem _$UserVoicemailItemFromJson(Map<String, dynamic> json) => UserVoicemailItem(
...
Map<String, dynamic> _$UserVoicemailItemToJson(UserVoicemailItem instance) => <String, dynamic>{
  'id': instance.id,
  'date': instance.date,
