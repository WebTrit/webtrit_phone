...
mixin _$AdapterInfo {
  ...
  String? get version => throw _privateConstructorUsedError;
  List<LoginType> get supported => throw _privateConstructorUsedError;
...
class _$_AdapterInfo implements _AdapterInfo {
  const _$_AdapterInfo(
      {this.name,
      this.version,
      final List<LoginType> supported = const [LoginType.otpSignin],
  ...
  @override
  final String? version;
  final List<LoginType> _supported;
  @override
  @JsonKey()
  List<LoginType> get supported {
...
abstract class _AdapterInfo implements AdapterInfo {
  const factory _AdapterInfo(
      {final String? name,
      final String? version,
      final List<LoginType> supported,
