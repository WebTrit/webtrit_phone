...
mixin _$SystemNotification {
 ...
 int get id; String get title; String get content; bool get seen; SystemNotificationType get type; DateTime get createdAt; DateTime get updatedAt; DateTime? get readAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,content,seen,type,createdAt,updatedAt,readAt);
...
@useResult
$Res call({
 int id, String title, String content, bool seen, SystemNotificationType type, DateTime createdAt, DateTime updatedAt, DateTime? readAt
});
...
/// Create a copy of SystemNotification
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? content = null,Object? seen = null,Object? type = null,Object? createdAt = null,Object? updatedAt = null,Object? readAt = freezed,}) {
...
as SystemNotificationType,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SystemNotificationResponceCopyWith<SystemNotificationResponce> get copyWith => _$SystemNotificationResponceCopyWithImpl<SystemNotificationResponce>(this as SystemNotificationResponce, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SystemNotificationResponce&&const DeepCollectionEquality().equals(other.items, items));
}
...
abstract mixin class $SystemNotificationResponceCopyWith<$Res>  {
  factory $SystemNotificationResponceCopyWith(SystemNotificationResponce value, $Res Function(SystemNotificationResponce) _then) = _$SystemNotificationResponceCopyWithImpl;
@useResult
$Res call({
 List<SystemNotification> items
});
