...
mixin _$DemoCallToActionsResponse {
  ...
  $DemoCallToActionsResponseCopyWith<DemoCallToActionsResponse> get copyWith =>
      _$DemoCallToActionsResponseCopyWithImpl<DemoCallToActionsResponse>(
          this as DemoCallToActionsResponse, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DemoCallToActionsResponse &&
...
abstract mixin class $DemoCallToActionsResponseCopyWith<$Res> {
  factory $DemoCallToActionsResponseCopyWith(DemoCallToActionsResponse value,
          $Res Function(DemoCallToActionsResponse) _then) =
...
mixin _$DemoCallToActionsResponseActions {
  ...
  $DemoCallToActionsResponseActionsCopyWith<DemoCallToActionsResponseActions>
      get copyWith => _$DemoCallToActionsResponseActionsCopyWithImpl<
              DemoCallToActionsResponseActions>(
          this as DemoCallToActionsResponseActions, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DemoCallToActionsResponseActions &&
...
abstract mixin class $DemoCallToActionsResponseActionsCopyWith<$Res> {
  factory $DemoCallToActionsResponseActionsCopyWith(
          ...
          $Res Function(DemoCallToActionsResponseActions) _then) =
...
extension DemoCallToActionsResponseActionsPatterns
    on DemoCallToActionsResponseActions {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
...
mixin _$DemoCallToActionsResponseActionsExtraData {
  ...
  $DemoCallToActionsResponseActionsExtraDataCopyWith<
      ...
      get copyWith => _$DemoCallToActionsResponseActionsExtraDataCopyWithImpl<
              DemoCallToActionsResponseActionsExtraData>(
          this as DemoCallToActionsResponseActionsExtraData, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DemoCallToActionsResponseActionsExtraData &&
...
abstract mixin class $DemoCallToActionsResponseActionsExtraDataCopyWith<$Res> {
  factory $DemoCallToActionsResponseActionsExtraDataCopyWith(
          ...
          $Res Function(DemoCallToActionsResponseActionsExtraData) _then) =
...
extension DemoCallToActionsResponseActionsExtraDataPatterns
    on DemoCallToActionsResponseActionsExtraData {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
