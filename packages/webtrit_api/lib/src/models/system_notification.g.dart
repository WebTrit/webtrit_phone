...
SystemNotificationResponce _$SystemNotificationResponceFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$SystemNotificationResponceToJson(SystemNotificationResponce instance) => <String, dynamic>{
