...
AppConfigSettingsItem _$AppConfigSettingsItemFromJson(Map<String, dynamic> json) => AppConfigSettingsItem(
  ...
  embeddedResourceId: const IntToStringOptionalConverter().fromJson(json['embeddedResourceId']),
);
...
Map<String, dynamic> _$AppConfigSettingsItemToJson(AppConfigSettingsItem instance) => <String, dynamic>{
  ...
  'type': instance.type,
  'icon': instance.icon,
  'embeddedResourceId': const IntToStringOptionalConverter().toJson(instance.embeddedResourceId),
};
...
EmbeddedTabScheme _$EmbeddedTabSchemeFromJson(Map<String, dynamic> json) => EmbeddedTabScheme(
  ...
  titleL10n: json['titleL10n'] as String,
  icon: json['icon'] as String,
  embeddedResourceId: const IntToStringConverter().fromJson(json['embeddedResourceId']),
  $type: json['type'] as String?,
);
...
Map<String, dynamic> _$EmbeddedTabSchemeToJson(EmbeddedTabScheme instance) => <String, dynamic>{
  ...
  'titleL10n': instance.titleL10n,
  'icon': instance.icon,
  'embeddedResourceId': const IntToStringConverter().toJson(instance.embeddedResourceId),
  'type': instance.$type,
};
