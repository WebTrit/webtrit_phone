...
AppConfig _$AppConfigFromJson(Map<String, dynamic> json) => AppConfig(
  ...
  settingsConfig: json['settingsConfig'] == null
      ...
      : AppConfigSettings.fromJson(json['settingsConfig'] as Map<String, dynamic>),
  ...
  localization: json['localization'] == null
      ...
      : AppConfigLocalization.fromJson(json['localization'] as Map<String, dynamic>),
  supported:
  ...
  r'$defs': {
    ...
    'AppConfigLoginQrFormat': {
      ...
      'properties': {
        ...
        'schemes': {
          'type': 'array',
          'items': {'type': 'string'},
          'description': '`uri` only: accepted scheme names, matched case-insensitively.',
        },
      },
      'required': ['type'],
    },
    ...
    'AppConfigEncoding': {
      ...
      'properties': {
        ...
        'defaultPresetOverride': {r'$ref': r'#/$defs/EncodingDefaultPresetOverride'},
      },
    },
...
AppConfigLogin _$AppConfigLoginFromJson(Map<String, dynamic> json) => AppConfigLogin(
  common: json['common'] == null
      ? const AppConfigLoginCommon()
      : AppConfigLoginCommon.fromJson(json['common'] as Map<String, dynamic>),
...
Map<String, dynamic> _$AppConfigLoginToJson(AppConfigLogin instance) => <String, dynamic>{
...
AppConfigLoginQr _$AppConfigLoginQrFromJson(Map<String, dynamic> json) => AppConfigLoginQr(
...
Map<String, dynamic> _$AppConfigLoginQrToJson(AppConfigLoginQr instance) => <String, dynamic>{
...
AppConfigLoginQrFormat _$AppConfigLoginQrFormatFromJson(Map<String, dynamic> json) => AppConfigLoginQrFormat(
  type: json['type'] as String,
  schemes: (json['schemes'] as List<dynamic>?)?.map((e) => e as String).toList(),
);

Map<String, dynamic> _$AppConfigLoginQrFormatToJson(AppConfigLoginQrFormat instance) => <String, dynamic>{
  'type': instance.type,
...
AppConfigLoginCommon _$AppConfigLoginCommonFromJson(Map<String, dynamic> json) =>
    AppConfigLoginCommon(fullScreenLaunchEmbeddedResourceId: json['fullScreenLaunchEmbeddedResourceId'] as String?);

Map<String, dynamic> _$AppConfigLoginCommonToJson(AppConfigLoginCommon instance) => <String, dynamic>{
  'fullScreenLaunchEmbeddedResourceId': instance.fullScreenLaunchEmbeddedResourceId,
};
...
AppConfigLoginModeSelect _$AppConfigLoginModeSelectFromJson(Map<String, dynamic> json) => AppConfigLoginModeSelect(
...
AppConfigModeSelectAction _$AppConfigModeSelectActionFromJson(Map<String, dynamic> json) => AppConfigModeSelectAction(
...
Map<String, dynamic> _$AppConfigModeSelectActionToJson(AppConfigModeSelectAction instance) => <String, dynamic>{
  'enabled': instance.enabled,
  'type': instance.type,
...
AppConfigMain _$AppConfigMainFromJson(Map<String, dynamic> json) => AppConfigMain(
  bottomMenu: json['bottomMenu'] == null
      ...
      : AppConfigBottomMenu.fromJson(json['bottomMenu'] as Map<String, dynamic>),
  systemNotificationsEnabled: json['systemNotificationsEnabled'] as bool? ?? true,
);

Map<String, dynamic> _$AppConfigMainToJson(AppConfigMain instance) => <String, dynamic>{
...
AppConfigBottomMenu _$AppConfigBottomMenuFromJson(Map<String, dynamic> json) => AppConfigBottomMenu(
  cacheSelectedTab: json['cacheSelectedTab'] as bool? ?? true,
  tabs:
      (json['tabs'] as List<dynamic>?)?.map((e) => BottomMenuTabScheme.fromJson(e as Map<String, dynamic>)).toList() ??
      const [],
);

Map<String, dynamic> _$AppConfigBottomMenuToJson(AppConfigBottomMenu instance) => <String, dynamic>{
...
AppConfigCall _$AppConfigCallFromJson(Map<String, dynamic> json) => AppConfigCall(
  videoEnabled: json['videoEnabled'] as bool? ?? true,
  transfer: json['transfer'] == null
      ? const AppConfigTransfer(enableBlindTransfer: true, enableAttendedTransfer: true)
  ...
  peerConnection: json['peerConnection'] == null
      ...
      : AppConfigPeerConnection.fromJson(json['peerConnection'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigCallToJson(AppConfigCall instance) => <String, dynamic>{
...
AppConfigTransfer _$AppConfigTransferFromJson(Map<String, dynamic> json) => AppConfigTransfer(
  enableBlindTransfer: json['enableBlindTransfer'] as bool? ?? true,
  enableAttendedTransfer: json['enableAttendedTransfer'] as bool? ?? true,
);

Map<String, dynamic> _$AppConfigTransferToJson(AppConfigTransfer instance) => <String, dynamic>{
...
AppConfigEncoding _$AppConfigEncodingFromJson(Map<String, dynamic> json) => AppConfigEncoding(
  ...
  defaultPresetOverride: json['defaultPresetOverride'] == null
      ...
      : EncodingDefaultPresetOverride.fromJson(json['defaultPresetOverride'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigEncodingToJson(AppConfigEncoding instance) => <String, dynamic>{
...
AppConfigPeerConnection _$AppConfigPeerConnectionFromJson(Map<String, dynamic> json) => AppConfigPeerConnection(
  negotiation: json['negotiation'] == null
      ? const AppConfigNegotiationSettingsOverride()
      : AppConfigNegotiationSettingsOverride.fromJson(json['negotiation'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigPeerConnectionToJson(AppConfigPeerConnection instance) => <String, dynamic>{
...
AppConfigNegotiationSettingsOverride _$AppConfigNegotiationSettingsOverrideFromJson(Map<String, dynamic> json) =>
    AppConfigNegotiationSettingsOverride(
      includeInactiveVideoInOfferAnswer: json['includeInactiveVideoInOfferAnswer'] as bool? ?? false,
    );

Map<String, dynamic> _$AppConfigNegotiationSettingsOverrideToJson(AppConfigNegotiationSettingsOverride instance) =>
    <String, dynamic>{'includeInactiveVideoInOfferAnswer': instance.includeInactiveVideoInOfferAnswer};
...
EncodingDefaultPresetOverride _$EncodingDefaultPresetOverrideFromJson(Map<String, dynamic> json) =>
    EncodingDefaultPresetOverride(
      ...
      removeExtmaps: (json['removeExtmaps'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );

Map<String, dynamic> _$EncodingDefaultPresetOverrideToJson(EncodingDefaultPresetOverride instance) => <String, dynamic>{
...
AppConfigSettingsSection _$AppConfigSettingsSectionFromJson(Map<String, dynamic> json) => AppConfigSettingsSection(
  titleL10n: json['titleL10n'] as String,
  enabled: json['enabled'] as bool? ?? true,
  items:
      (json['items'] as List<dynamic>?)
          ?.map((e) => AppConfigSettingsItem.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
);

Map<String, dynamic> _$AppConfigSettingsSectionToJson(AppConfigSettingsSection instance) => <String, dynamic>{
  'titleL10n': instance.titleL10n,
  'enabled': instance.enabled,
...
AppConfigSettingsItem _$AppConfigSettingsItemFromJson(Map<String, dynamic> json) => AppConfigSettingsItem(
  enabled: json['enabled'] as bool? ?? true,
  titleL10n: json['titleL10n'] as String,
  type: json['type'] as String,
  icon: json['icon'] as String,
...
Map<String, dynamic> _$AppConfigSettingsItemToJson(AppConfigSettingsItem instance) => <String, dynamic>{
  'enabled': instance.enabled,
  'titleL10n': instance.titleL10n,
  'type': instance.type,
  'icon': instance.icon,
...
AppConfigContacts _$AppConfigContactsFromJson(Map<String, dynamic> json) => AppConfigContacts(
  list: json['list'] == null
  ...
  details: json['details'] == null
      ...
      : AppConfigContactDetails.fromJson(json['details'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigContactsToJson(AppConfigContacts instance) => <String, dynamic>{
...
AppConfigContactList _$AppConfigContactListFromJson(Map<String, dynamic> json) => AppConfigContactList();

Map<String, dynamic> _$AppConfigContactListToJson(AppConfigContactList instance) => <String, dynamic>{};
...
AppConfigContactDetails _$AppConfigContactDetailsFromJson(Map<String, dynamic> json) => AppConfigContactDetails(
  actions: json['actions'] == null
      ? const AppConfigContactDetailsActions()
      : AppConfigContactDetailsActions.fromJson(json['actions'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigContactDetailsToJson(AppConfigContactDetails instance) => <String, dynamic>{
...
AppConfigContactDetailsActions _$AppConfigContactDetailsActionsFromJson(Map<String, dynamic> json) =>
    AppConfigContactDetailsActions(
      appBar: (json['appBar'] as List<dynamic>?)?.map((e) => e as String).toList(),
      phoneTile: (json['phoneTile'] as List<dynamic>?)?.map((e) => e as String).toList(),
      emailTile: (json['emailTile'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );

Map<String, dynamic> _$AppConfigContactDetailsActionsToJson(AppConfigContactDetailsActions instance) =>
    <String, dynamic>{'appBar': instance.appBar, 'phoneTile': instance.phoneTile, 'emailTile': instance.emailTile};
...
AppConfigMessaging _$AppConfigMessagingFromJson(Map<String, dynamic> json) => AppConfigMessaging(
  sms: json['sms'] == null ? const AppConfigSms() : AppConfigSms.fromJson(json['sms'] as Map<String, dynamic>),
  chats: json['chats'] == null
      ? const AppConfigChats()
      : AppConfigChats.fromJson(json['chats'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigMessagingToJson(AppConfigMessaging instance) => <String, dynamic>{
...
AppConfigSms _$AppConfigSmsFromJson(Map<String, dynamic> json) => AppConfigSms();

Map<String, dynamic> _$AppConfigSmsToJson(AppConfigSms instance) => <String, dynamic>{};
...
AppConfigChats _$AppConfigChatsFromJson(Map<String, dynamic> json) => AppConfigChats(
  groupChatButtonEnabled: json['groupChatButtonEnabled'] as bool? ?? true,
  contactInfo: json['contactInfo'] == null
      ? const ChatContactInfo()
      : ChatContactInfo.fromJson(json['contactInfo'] as Map<String, dynamic>),
);

Map<String, dynamic> _$AppConfigChatsToJson(AppConfigChats instance) => <String, dynamic>{
...
ChatContactInfo _$ChatContactInfoFromJson(Map<String, dynamic> json) =>
    ChatContactInfo(showVideoButtonAction: json['showVideoButtonAction'] as bool? ?? true);

Map<String, dynamic> _$ChatContactInfoToJson(ChatContactInfo instance) => <String, dynamic>{
  'showVideoButtonAction': instance.showVideoButtonAction,
};
...
AppConfigLocalization _$AppConfigLocalizationFromJson(Map<String, dynamic> json) => AppConfigLocalization(
  enabledLanguages: (json['enabledLanguages'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
);

Map<String, dynamic> _$AppConfigLocalizationToJson(AppConfigLocalization instance) => <String, dynamic>{
