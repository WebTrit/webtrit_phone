...
LeadingAvatarStyleConfig _$LeadingAvatarStyleConfigFromJson(Map<String, dynamic> json) => LeadingAvatarStyleConfig(
  backgroundColor: json['backgroundColor'] as String?,
  radius: (json['radius'] as num?)?.toDouble(),
  initialsTextStyle: json['initialsTextStyle'] == null
      ? null
      : TextStyleConfig.fromJson(json['initialsTextStyle'] as Map<String, dynamic>),
  placeholderIcon: json['placeholderIcon'] == null
      ? null
      : IconDataConfig.fromJson(json['placeholderIcon'] as Map<String, dynamic>),
  loading: json['loading'] == null ? null : LoadingOverlayStyleConfig.fromJson(json['loading'] as Map<String, dynamic>),
  smartIndicator: json['smartIndicator'] == null
      ? null
      : SmartIndicatorStyleConfig.fromJson(json['smartIndicator'] as Map<String, dynamic>),
  registeredBadge: json['registeredBadge'] == null
      ? null
      : RegisteredBadgeStyleConfig.fromJson(json['registeredBadge'] as Map<String, dynamic>),
  presenceBadge: json['presenceBadge'] == null
      ? null
      : PresenceBadgeStyleConfig.fromJson(json['presenceBadge'] as Map<String, dynamic>),
  nameColors: json['nameColors'] == null
      ? null
      : NameColorsStyleConfig.fromJson(json['nameColors'] as Map<String, dynamic>),
);

Map<String, dynamic> _$LeadingAvatarStyleConfigToJson(LeadingAvatarStyleConfig instance) => <String, dynamic>{
...
const _$LeadingAvatarStyleConfigJsonSchema = {
  ...
  'properties': {
    ...
    'nameColors': {r'$ref': r'#/$defs/NameColorsStyleConfig', 'description': 'Per-name pseudorandom color appearance.'},
  },
  r'$defs': {
    'FontWeightConfig': {
      'type': 'object',
...
NameColorsStyleConfig _$NameColorsStyleConfigFromJson(Map<String, dynamic> json) => NameColorsStyleConfig(
  enabled: json['enabled'] as bool? ?? true,
  palette: (json['palette'] as List<dynamic>?)?.map((e) => e as String).toList(),
);

Map<String, dynamic> _$NameColorsStyleConfigToJson(NameColorsStyleConfig instance) => <String, dynamic>{
...
LoadingOverlayStyleConfig _$LoadingOverlayStyleConfigFromJson(Map<String, dynamic> json) => LoadingOverlayStyleConfig(
...
Map<String, dynamic> _$LoadingOverlayStyleConfigToJson(LoadingOverlayStyleConfig instance) => <String, dynamic>{
...
SmartIndicatorStyleConfig _$SmartIndicatorStyleConfigFromJson(Map<String, dynamic> json) => SmartIndicatorStyleConfig(
  backgroundColor: json['backgroundColor'] as String?,
  icon: json['icon'] == null ? null : IconDataConfig.fromJson(json['icon'] as Map<String, dynamic>),
  sizeFactor: (json['sizeFactor'] as num?)?.toDouble(),
);

Map<String, dynamic> _$SmartIndicatorStyleConfigToJson(SmartIndicatorStyleConfig instance) => <String, dynamic>{
  'backgroundColor': instance.backgroundColor,
  'icon': instance.icon,
...
RegisteredBadgeStyleConfig _$RegisteredBadgeStyleConfigFromJson(Map<String, dynamic> json) =>
    RegisteredBadgeStyleConfig(
...
Map<String, dynamic> _$RegisteredBadgeStyleConfigToJson(RegisteredBadgeStyleConfig instance) => <String, dynamic>{
...
PresenceBadgeStyleConfig _$PresenceBadgeStyleConfigFromJson(Map<String, dynamic> json) => PresenceBadgeStyleConfig(
...
Map<String, dynamic> _$PresenceBadgeStyleConfigToJson(PresenceBadgeStyleConfig instance) => <String, dynamic>{
...
const _$PresenceBadgeStyleConfigJsonSchema = {
  ...
  'properties': {
    ...
    'unavailableColor': {'type': 'string', 'description': 'Color used when presence is "unavailable" (e.g., offline).'},
    'busyColor': {
      'type': 'string',
      'description':
          'Color used when the contact should not be called right now: one\npublishing "busy" or "do not disturb".',
    ...
    'iconColor': {
      'type': 'string',
      'description': 'Color of the activity glyph drawn inside the badge; it has to read on\ntop of the badge fill.',
    },
    'sizeFactor': {'type': 'number', 'description': 'Size factor relative to avatar diameter.'},
  },
};
