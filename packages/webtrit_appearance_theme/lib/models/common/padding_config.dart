...
class PaddingConfig with _$PaddingConfig {
  ...
  factory PaddingConfig.fromJson(Map<String, Object?> json) =>
  ...
  factory PaddingConfig.all(double value) =>
      PaddingConfig(left: value, top: value, right: value, bottom: value);

  /// Default padding of 2 on all sides.
  static const PaddingConfig default2 =
      PaddingConfig(left: 2, top: 2, right: 2, bottom: 2);
}
