...
ButtonStyleConfig _$ButtonStyleConfigFromJson(Map<String, dynamic> json) => ButtonStyleConfig(
  ...
  padding: json['padding'] == null ? null : EdgeInsetsConfig.fromJson(json['padding'] as Map<String, dynamic>),
  minimumSize: json['minimumSize'] == null ? null : SizeConfig.fromJson(json['minimumSize'] as Map<String, dynamic>),
  fixedSize: json['fixedSize'] == null ? null : SizeConfig.fromJson(json['fixedSize'] as Map<String, dynamic>),
  maximumSize: json['maximumSize'] == null ? null : SizeConfig.fromJson(json['maximumSize'] as Map<String, dynamic>),
  iconColor: json['iconColor'] as String?,
  iconSize: (json['iconSize'] as num?)?.toDouble(),
  side: json['side'] == null ? null : BorderSideConfig.fromJson(json['side'] as Map<String, dynamic>),
  shape: json['shape'] == null ? null : ShapeBorderConfig.fromJson(json['shape'] as Map<String, dynamic>),
  visualDensity: json['visualDensity'] == null
      ? null
      : VisualDensityConfig.fromJson(json['visualDensity'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ButtonStyleConfigToJson(ButtonStyleConfig instance) => <String, dynamic>{
...
const _$ButtonStyleConfigJsonSchema = {
  ...
  'properties': {
    ...
    'shape': {r'$ref': r'#/$defs/ShapeBorderConfig', 'description': 'The shape of the button (e.g., rounded corners).'},
    'visualDensity': {
