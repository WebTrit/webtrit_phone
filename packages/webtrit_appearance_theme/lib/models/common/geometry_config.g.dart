...
SizeConfig _$SizeConfigFromJson(Map<String, dynamic> json) =>
    SizeConfig(width: (json['width'] as num).toDouble(), height: (json['height'] as num).toDouble());

Map<String, dynamic> _$SizeConfigToJson(SizeConfig instance) => <String, dynamic>{
...
EdgeInsetsConfig _$EdgeInsetsConfigFromJson(Map<String, dynamic> json) => EdgeInsetsConfig(
...
Map<String, dynamic> _$EdgeInsetsConfigToJson(EdgeInsetsConfig instance) => <String, dynamic>{
  'left': instance.left,
  'top': instance.top,
...
BorderSideConfig _$BorderSideConfigFromJson(Map<String, dynamic> json) => BorderSideConfig(
  color: json['color'] as String?,
  width: (json['width'] as num?)?.toDouble() ?? 1.0,
  style: json['style'] as String? ?? 'solid',
);

Map<String, dynamic> _$BorderSideConfigToJson(BorderSideConfig instance) => <String, dynamic>{
...
ShapeBorderConfig _$ShapeBorderConfigFromJson(Map<String, dynamic> json) => ShapeBorderConfig(
  type: json['type'] as String? ?? 'rounded',
  borderRadius: (json['borderRadius'] as num?)?.toDouble(),
);

Map<String, dynamic> _$ShapeBorderConfigToJson(ShapeBorderConfig instance) => <String, dynamic>{
  'type': instance.type,
...
VisualDensityConfig _$VisualDensityConfigFromJson(Map<String, dynamic> json) => VisualDensityConfig(
  horizontal: (json['horizontal'] as num?)?.toDouble() ?? 0.0,
  vertical: (json['vertical'] as num?)?.toDouble() ?? 0.0,
);

Map<String, dynamic> _$VisualDensityConfigToJson(VisualDensityConfig instance) => <String, dynamic>{
