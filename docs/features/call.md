...
that bridges signaling, native call UI, WebRTC media, and the Flutter UI layer. This doc covers
the feature and its architecture; the product/UX view lives in
[`call_ux.md`](call_ux.md).
