...
void main() {
  ...
  testWidgets('overflow menu offers delete and cache management', (tester) async {
  ...
  testWidgets('hides the cache item when no cache sections are registered', (tester) async {
