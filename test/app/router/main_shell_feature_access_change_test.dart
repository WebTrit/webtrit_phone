...
void main() {
  ...
  testWidgets(
    'a runtime FeatureAccess update must not kill the blocs open screens use',
    (tester) async {
    ...
    // WT-1845: proven red on the current shell (the update recreates the bloc
    // layer, orphaning the captured instance); unskip in the fix PR.
    skip: true,
  );
}
